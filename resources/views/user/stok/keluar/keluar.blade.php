                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm whitespace-nowrap">
                        ...
                        <tbody class="divide-y divide-border" id="stokTable">
                            @include('user.stok.keluar.table')
                        </tbody>
                    </table>
                </div>
                <div
                                ...
                                <div class="space-y-4">
                                    <div
                                        ...
                                        <div class="text-right">
                                            <p id="cek-stok" class="font-bold text-sm text-foreground"></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="border border-border rounded-2xl shadow-sm p-6 md:p-8">
                        ...
                        <div class="space-y-4">
                            <div
                                ...
                                <div class="text-right">
                                    <p id="stok" class="font-bold text-sm text-foreground"></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            function showDetail(id) {
                ...
                fetch(`/user/menu/stok-keluar/${id}`)
                    ...
                    .then(data => {
                        ...
                        const stokEl1 = document.getElementById("stok");
