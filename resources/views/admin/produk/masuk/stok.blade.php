                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm whitespace-nowrap">
                        ...
                        <tbody class="divide-y divide-border" id="stokTable">
                            @include('admin.produk.masuk.table')
                        </tbody>
                    </table>
                </div>
                <div
    ...
    @push('js')
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                if (btnBuat) {
                    btnBuat.addEventListener("click", async function() {
                        try {
                            ...
                            const res = await fetch("/admin/master/menu/stok-masuk", {
                                method: "POST",
                                headers: {
                                    "X-CSRF-TOKEN": csrf,
                ...
                btnTambah.addEventListener("click", async function() {
                    ...
                    try {
                        ...
                        const res = await fetch("/admin/master/menu/stok-transaksi", {
                            method: "POST",
                            headers: {
                                "X-CSRF-TOKEN": csrf,
                                "Accept": "application/json",
            ...
            function editData(id) {
                ...
                fetch(`/admin/master/menu/stok-masuk/${id}`)
                    .then(res => res.json())
                    .then(data => {
            ...
            if (editForm) {
                editForm.addEventListener('submit', async function(e) {
                    ...
                    try {
                        const res = await fetch(`/admin/master/menu/stok-edit/${id}`, {
                            method: "POST",
                            headers: {
            ...
            function deleteData(id) {
                ...
                fetch(`/admin/master/menu/stok-hapus/${id}`, {
                        method: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': csrfToken,
                            'Accept': 'application/json'
            ...
            async function updateStatus() {
                ...
                try {
                    ...
                    const res = await fetch(`/admin/master/menu/stok-status/${id}`, {
